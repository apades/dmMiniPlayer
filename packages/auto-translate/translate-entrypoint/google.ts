...
import { TranslateEntrypointModule } from '../types'

export const googleTranslateModule: TranslateEntrypointModule = {
  enable: (config) => config.target === 'google',
  translate(text, toLang, config) {
